...
plt.scatter(y_train_pred, y_train_pred - y_train,
            c = 'steelblue', marker = 's', edgecolor = 'white',
            label = 'Training data')
...
plt.scatter(ridge_train_pred, ridge_train_pred - y_train,
            c = 'steelblue', marker = 's', edgecolor = 'white',
            label = 'Training data')
...
plt.scatter(ridge_1_train_pred, ridge_1_train_pred - y_train,
            c = 'steelblue', marker = 's', edgecolor = 'white',
            label = 'Training data')
...
plt.scatter(ridge_2_train_pred, ridge_2_train_pred - y_train,
            c = 'steelblue', marker = 's', edgecolor = 'white',
            label = 'Training data')
...
plt.scatter(lasso_train_pred, lasso_train_pred - y_train,
            c = 'steelblue', marker = 's', edgecolor = 'white',
            label = 'Training data')
...
plt.scatter(lasso_1_train_pred, lasso_1_train_pred - y_train,
            c = 'steelblue', marker = 's', edgecolor = 'white',
            label = 'Training data')
...
plt.scatter(lasso_2_train_pred, lasso_2_train_pred - y_train,
            c = 'steelblue', marker = 's', edgecolor = 'white',
            label = 'Training data')
